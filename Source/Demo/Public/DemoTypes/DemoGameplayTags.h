...
// UI.Settings.*
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Settings_Graphics);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Settings_Audio);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Settings_Controls);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Settings_System);
} // namespace DemoGameplayTags