...
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_Boss_Intro);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_Boss_Victory);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_Hit_Default);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_Hit_Metal);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_Hit_Block);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_LockOn);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Combat_YouDied);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Item_PickUp);
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SFX_Item_Drop);
...
DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Error);
